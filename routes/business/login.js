    ...
    User.findOne({
       ...
       .then( u => {
           ...
           const mailOptions = {
                ...
                html: `Hello,<br/> The confirmation code is below — enter it in your open browser window to login in:<br/><h2><b>${code}</b></h2> Welcome in,<br/> PatenTrack <br/><br/>If you didn’t request this email, there’s nothing to worry about — you can safely ignore it.`
           }
