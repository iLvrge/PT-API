...
let createJSON = async(itemDetails, rfID) => {
    ...
    if(itemDetails !== undefined && itemDetails.assignor.length > 0) {
        ...
        itemDetails.assignor.forEach( (assignor, index) => {
            ...
            assignors.push({recorded_name: assignor.original_name, normalize_name: assignor.normalize_name});
        ...
        itemDetails.assignee.forEach( assignee => {
            ...
            assignees.push({recorded_name: assignee.original_name, normalize_name: assignee.normalize_name});
