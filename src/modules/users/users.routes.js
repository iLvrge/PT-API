...
router.put('/customers/:id/users/:user_id', validate(schema.updateUserSchema), controller.update);
router.delete('/customers/:id/users/:user_id', validate(schema.deleteUserSchema), controller.remove);
