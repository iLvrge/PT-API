...
router.get('/asset_types/assignments/:rf_id', guard, validate(schema.rfIdSchema), controller.assignmentAssets);
...
router.get('/:parent_company/parties/:tab_id', guard, controller.parentParties);
router.get('/:parent_company/:name/collections/:tab_id', verifyToken, controller.parentCollections);
