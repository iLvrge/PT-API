...
const tabLifeSpan = (summary, params) => ({
  get: h.operation({
    ...
    summary,
    params,
    ok: chartResponse('Year-by-year asset counts, as a charting table.'),
    errors: T,
  }),
});
...
module.exports = {
  '/events/tabs': {
    get: h.operation({
      ...
      ok: chartResponse('Year-by-year asset counts, as a charting table: a header row, then [year, count, style].'),
      errors: E,
    }),
  },
